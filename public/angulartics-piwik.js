/**
 *
 * Simplyfied version of angular-piwik
 * with a custom management to write a correct document title
 */
        ...
        .config(['$analyticsProvider', '$windowProvider',
            function ($analyticsProvider, $windowProvider) {
                ...
                $analyticsProvider.registerPageTrack(function (path, locationObj) {
                  ...
                  if ($window._paq) {
                    $window._paq.push(['setDocumentTitle', getTitleFromUrl(locationObj.$$absUrl) || $window.document.title]);
